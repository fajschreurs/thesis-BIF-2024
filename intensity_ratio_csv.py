...
then saving in a csv file the z-slice number and the corresponding ratio
...
path = r"C:/Users/Schre082/OneDrive - Wageningen University & Research/Master thesis BIF/data/23052024_Femke_Schreurs_spinazie_2.sptw/"
os.chdir(path)
...
output_file_name = f"intensity_ratio_{folder_name}.csv"
